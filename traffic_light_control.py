#revisi kedua reward adalah keseluruhan waiting time
...
class DQNAgent:
    def __init__(self):
        ...
        self.learning_rate = 0.01 # learning rate dari q learning, kalo 0 berarti q value tidak pernah diupdate
...
class SumoIntersection:
    ...
    def getState(self):
        ...
        return [density_state, preemption_duration_state]
...
if __name__ == '__main__':
    ...
    for e in range(episodes):
        ...
        period_nonev = random.randint(1, 9)
        ...
        while traci.simulation.getMinExpectedNumber() > 0:
            ...
            if preemption_status=="done" :
                ...
                previous_reward = sumoInt.getReward()
            ...
            if preemption_status=="" and exitstrategy_status=="on":
                match chosen_exit_strategy:
                    ...
                    case 10|11|12|13:
                        ...
                        #     traci.trafficlight.setPhase("tls", current_trafficlight)
                        if (threshold_start_at_timestepexit+(all_duration*(len(dtt_phase[:2]))+1) == step):
